    ...
    <div class="swiper-container slider-1">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="./images/balan.jpg" alt="" />
        </div>

        <div class="swiper-slide">
          <img src="./images/balan1.jpg" alt="hero image" />
        </div>
        <div class="swiper-slide">
          <img src="./images/balan2.jpg" alt="hero image" />
        </div>
      </div>
    </div>
    ...
    <section class="section about" id="about">
      <div class="row container" style="display: flex">
        <div class="col">
          ...
          <p>
            Traseul începe din Izvorul Muntelui. De aici aveți de mers cam 40 de minute până vă intersectați cu o șosea
            pietruită.
            Aveți grijă însă să nu mergeți în dreaptă pentru că veți ajunge pe traseul Jgheabul Armenilor, un traseu nu
            foarte ușor pentru început.
            De aici continuă un urcuș puternic prin pădure. S-ar putea să aveți impresia că ați trecut de jumătate de
            traseu, însă nu e deloc așa.
            Imediat vă veți intersecta cu un indicator care vă arată că mai aveți 2 ore și 45 de minute până la Cabana
            Dochia.
          </p>
        </div>
        <div class="col">
                  ...
                  function init_map() {
                    ...
                    directionsService
                      .route({
                        ...
                        destination: {
                          query: 'Cabana Singuratica, Romania',
                        },
