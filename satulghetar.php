        ...
        <div class="swiper-container slider-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./images/Pestera-Scarisoara-Apuseni.jpg" alt="" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/ghetarul-scarisoara.jpg" alt="hero image" />
                </div>
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        Aflata in apropierea Muntilor Bucegi, Curmatura sau Saua Baiului face legatura intre muntele
                        Diham si
                        Clabucetul Baiului.
                        De la Saua Baiului poti porni pe un traseu care este accesibil tot timpul anului si pentru care
                        nu ai nevoie
                        de echipament special.
                        Treci pe langa Varful Leuca Mica si prin Valea Grecului si ajungi, intr-un final, in statiunea
                        Azuga.
                    </p>
                </div>
                <div class="col">
                                ...
                                function init_map() {
                                    ...
                                    const onChangeHandler = function() {
                                        ...
                                        directionsService
                                            .route({
                                                origin: {
                                                    query: 'Satul Ghetar, Romania',
                                                },
                                                destination: {
                                                    query: 'Pestera Scarisoara, Romania',
                                                },
