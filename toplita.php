        ...
        <div class="swiper-container slider-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./images/Toplita - Varful Retitis - Gura Haitii (Transcalimani)/cascada-toplita_79461200.jpg" alt="" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Toplita - Varful Retitis - Gura Haitii (Transcalimani)/DSCN3752.JPG" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Toplita - Varful Retitis - Gura Haitii (Transcalimani)/ghenadie-cebanu-2y-Q4ci6reQ-unsplash.jpg" alt="hero image" />
                </div>
            </div>
        </div>
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        Drumul care travereseaza Muntii Calimani de la Toplita la Gura Haitii trecand chiar pe langa
                        varful Retitis si statia meteo este fara discutie unul dintre cele mai frumoase drumuri pentru
                        mountain bike din tara, dar si unul dintre cele mai putin cunoscute. Fara sa puna probleme
                        tehnice deosebite, acest drum este la indemana oricui cu conditia sa detina o bicicleta
                        potrivita.
                </div>
                <div class="col">
                                ...
                                function init_map() {
                                    ...
                                    const onChangeHandler = function() {
                                        ...
                                        directionsService
                                            .route({
                                                origin: {
                                                    query: 'Toplita, Romania',
                                                },
                                                destination: {
                                                    query: 'Gura Haitii, Romania',
                                                },
                                                waypoints: [{
                                                    location: 'Varful Retitis,  Romania',
                                                    stopover: true,
                                                }],
