...
<body style="background-color:#fcfaf7;">
  ...
  <header class="header" id="header">
    ...
    <div class="swiper-container slider-1">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="./images/Pietrosul_Rodnei.jpg" alt="" />
        </div>

        <div class="swiper-slide">
          <img src="./images/PietrosulRodnei1.jpg" alt="hero image" />
        </div>
        <div class="swiper-slide">
          <img src="./images/PietrosulRodnei2.jpg" alt="hero image" />
        </div>
    ...
    <div class="content">
      <h1>
        Borsa - Varful Pietrosu - Tarnita la Cruce
      </h1>
    </div>
    ...
    <section class="section about" id="about">
      <div class="row container" style="display: flex">
        <div class="col">
          ...
          <p>
            Daca vrei sa alegi unul dintre cele mai populare trasee din Muntii Rodnei, atunci o poti lua de la Borsa
            spre Tarnita la Cruce. Drumul te duce spre cel mai inalt varf din Carpatii Orientali: Pietrosu Rodnei. Vei
            merge pe versantul sudic al Muntilor Rodnei, pe sub Varful Buhaescu Mare, pe Buhaescu Mic si Rebra. Este un
            traseu nerecomandat incepatorilor, pentru ca sunt peste 20 de kilometri de parcurs, in urcare, cu diferente
            de nivel de peste 2.000 de metri.
          </p>
        </div>
        <div class="col">
          <p>
                  ...
                  function init_map() {
                    ...
                    directionsService
                      .route({
                        ...
                        destination: {
                          query: 'Tarnita la Cruce, Romania',
                        },
                        waypoints: [{
                          location: 'Varful Pietrosu, Romania',
                          stopover: true,
                        }, ],
