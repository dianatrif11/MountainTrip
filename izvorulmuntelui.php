    ...
    <div class="swiper-container slider-1">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="./images/Izvorul_muntelui.jpg" alt="" />
        </div>

        <div class="swiper-slide">
          <img src="./images/Izvorul_muntelui2.jpg" alt="hero image" />
        </div>
        <div class="swiper-slide">
          <img src="./images/Izvorul_muntelui3.jpg" alt="hero image" />
        </div>
        <div class="swiper-slide">
          <img src="./images/Izvorul_muntelui4.jpg" alt="hero image" />
        </div>
      </div>
    </div>
    ...
    <section class="section about" id="about">
      <div class="row container" style="display: flex">
        <div class="col">
          ...
          <p>
            Daca vrei un drum pe Ceahlau, atunci poti alege un traseu usor, pornind de la cabana Izvorul Muntelui si
            ajungand, prin Curmatura Lutul Rosu, pana la Cabana Dochia. Dupa ce urci prin padure, la jumatatea traseului
            vei observa Varful Toaca. Un loc unde poti sa faci un mic popas este Piatra cu apa. Dupa ce te-ai odihnit
            putin la cabana Dochia, daca vrei, poti sa continui drumul pana la Varful Toaca. Poti face aceasta drumetie
            in orice anotimp.
          </p>
        </div>
        <div class="col">
                ...
                <script type="text/javascript">
                  function init_map() {
                    ...
                    directionsService
                      .route({
                        origin: {
                          query: 'Izvorul Muntelui, Romania',
                        },
                        destination: {
                          query: 'Cabana Dochia, Romania',
                        },
