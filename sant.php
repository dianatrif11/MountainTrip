...
<body style="background-color:#fcfaf7;">
    ...
    <header class="header" id="header">
        ...
        <div class="swiper-container slider-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./images/Comuna Sant - tabara Valea Blaznei - VARFUL Ineut/image-asset.jpeg" alt="" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Comuna Sant - tabara Valea Blaznei - VARFUL Ineut/image-asset (2).jpeg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Comuna Sant - tabara Valea Blaznei - VARFUL Ineut/IMG_20200830_141401-1024x768.jpg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Comuna Sant - tabara Valea Blaznei - VARFUL Ineut/Rodnei-4.jpg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Comuna Sant - tabara Valea Blaznei - VARFUL Ineut/Varful ineut.jpg" alt="hero image" />
                </div>
        ...
        <div class="content">
            <h1>
                Comuna Sant - Tabara Valea Blaznei - Varful Ineut
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        In zona Bistritei poti opta pentru un traseu dificil care porneste din DN17D, din centrul
                        comunei Sant. In aproximativ sase ore ajungi de la 600 m altitudine, la 2.279 m, pe Varful
                        Ineut. Drumul necesita echipament complex: bete de trekking, crampoane, pioleti, scripeti,
                        hamuri. Este bine sa stii ca vei putea face popas la tabara scolara si la cabanele din Valea
                        Blaznei.
                    </p>
                </div>
                <div class="col">
                            ...
                            <script type="text/javascript">
                                function init_map() {
                                    ...
                                    directionsService
                                        .route({
                                            origin: {
                                                query: 'Comuna Sant, Bistrita, Romania',
                                            },
                                            destination: {
                                                query: 'Varful Ineut, Bistrita, Romania',
                                            },
                                            waypoints: [{
                                                location: 'Tabara Valea Blaznei, Bistrita,  Romania',
                                                stopover: true,
                                            }, ],
