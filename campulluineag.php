        ...
        <div class="swiper-container slider-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./images/Campul lui Neag - Izvoarele Cernei - Cerna Sat/campulluineag.jpg" alt="" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Campul lui Neag - Izvoarele Cernei - Cerna Sat/cernasat.jpg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Campul lui Neag - Izvoarele Cernei - Cerna Sat/izvoarelecernei.jpg" alt="hero image" />
                </div>
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        Un drum foarte frumos de parcurs pe mountain bike este cel ce leaga valea Jiului de Vest de
                        Baile Herculane. Drumul este teoretic un drum national, dar nu a fost niciodată modernizat. El
                        te va purta din pitorescul vaii Jiului de Vest, la poalele Retezatului Mic ai a Oslei, peste
                        munte pana la Izvoarele Cernei, un izbuc unde râul tasneste efectiv din strafundul muntelui,
                        dintr-o mare pestera inca nedescoperita. In continuare se parcurge conturul lacului Iovanu unde
                        e posibil sa existe surpări de teren care nu pot fi trecute cu autoturismul, dar se pot trece
                        usor cu bicicleta. Finalul este la Cerna Sat de unde se poate continua pe drumul modernizat spre
                        Baile Herculane, pe asfalt.
                </div>
                <div class="col">
                                ...
                                function init_map() {
                                    ...
                                    const onChangeHandler = function() {
                                        ...
                                        directionsService
                                            .route({
                                                origin: {
                                                    query: 'Campul lui Neag, Romania',
                                                },
                                                destination: {
                                                    query: 'Cerna Sat, Romania',
                                                },
                                                waypoints: [{
                                                    location: 'Izvorul Cernei,  Romania',
                                                    stopover: true,
                                                }, ],
