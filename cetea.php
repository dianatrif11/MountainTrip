        ...
        <div class="swiper-container slider-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./images/Cetea - Baile Romane - Piatra cetii/17-TRASEU-PIATRA-CETII.jpg" alt="" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Cetea - Baile Romane - Piatra cetii/cimpueru-filip-qEY8Fs_bXhs-unsplash.jpg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Cetea - Baile Romane - Piatra cetii/56967c59d5cc10d864d955faac5ceb0e.jpg" alt="hero image" />
                </div>

                <div class="swiper-slide">
                    <img src="./images/Cetea - Baile Romane - Piatra cetii/cheile-vaii-cetii-sau-baile-romane_50abad3da155e.jpg" alt="hero image" />
                </div>
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        Baile Romane se afla in Cheile Cetii (la 2,5 km de satul Cetea, comuna Galda de Jos) in
                        interiorul carora sunt cascade spectaculoase. Aici vei putea admira patru formatiuni calcaroase
                        numite pietre: Sanditau, Sasa, Ticuiata si Mariuta. Accesul din satul Cetea pana la chei este
                        facil. La doi kilometri de la Baile Romane, drumul paraseste valea Cetii si urca, spre vest, la
                        Piatra Cetii.
                    </p>
                </div>
                <div class="col">
                                ...
                                function init_map() {
                                    ...
                                    directionsService
                                        .route({
                                            ...
                                            destination: {
                                                query: 'Piatra Cetii, Romania',
                                            },
                                            waypoints: [{
                                                location: 'Baile Romane,  Romania',
                                                stopover: true,
                                            }, ],
