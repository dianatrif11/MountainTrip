...
<body style="background-color:#fcfaf7;">
    ...
    <header class="header" id="header">
        <!-- Navigation -->
            ...
            <div class="swiper-container slider-1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./images/Busteni - Plaiul Munticelul - Poiana Costila - Pichetul Rosu- La Perpeleac - Cabana Malaiesti/busteni1.jpg"
                            alt="" />
                    </div>

                    <div class="swiper-slide">
                        <img src="./images/Busteni - Plaiul Munticelul - Poiana Costila - Pichetul Rosu- La Perpeleac - Cabana Malaiesti/busteni2.jpg"
                            alt="hero image" />
                    </div>
                    <div class="swiper-slide">
                        <img src="./images/Busteni - Plaiul Munticelul - Poiana Costila - Pichetul Rosu- La Perpeleac - Cabana Malaiesti/busteni6.jpg"
                            alt="hero image" />
                    </div>
                    <div class="swiper-slide">
                        <img src="./images/Busteni - Plaiul Munticelul - Poiana Costila - Pichetul Rosu- La Perpeleac - Cabana Malaiesti/busteni5.jpg"
                            alt="hero image" />
                    </div>
            ...
            <div class="content">
                <h1>
                    Busteni – Plaiul Munticelul – Poiana Costila – Pichetul Rosu – La Prepeleac – Cabana Malaiesti
        ...
        <section class="section about" id="about">
            <div class="row container" style="display: flex">
                <div class="col">
                    ...
                    <p>
                        Un traseu spectaculos, in care vei parcurge 12 kilometri trecand de la 925 m altitudine, la
                        1.720 m. Practic, vei merge in zona nord-estica a Bucegilor, inconjurand mare parte a masivului.
                        Iarna drumul este foarte periculos si dificil, mai ales intre Pichetul Rosu si Cabana Malaiesti.
                    </p>
                </div>
                <div class="col">
                                ...
                                <script type="text/javascript">
                                    function init_map() {
                                        ...
                                        directionsService
                                            .route({
                                                origin: {
                                                    query: 'Busteni, Romania',
                                                },
                                                destination: {
                                                    query: 'Cabana Malaiesti, Romania',
                                                },
                                                waypoints: [{
                                                        location: 'Poiana Costila, Romania',
                                                        stopover: true,
                                                    }, {
                                                        location: 'Pichetul Rosu, Romania',
                                                        stopover: true,
                                                    },
                                                    {
                                                        location: 'La Prepeleac, Romania',
                                                        stopover: true,
                                                    }
                                                ],
